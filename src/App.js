import kare1 from "./assets/kare1.jpg";
...
export default function WallArtShop() {
  ...
  const products = [
    ...
    { id: 2, name: "Soyut Kompozisyon", images: ["kare1.jpg"], priceFramed: 920, priceUnframed: 520, category: "Soyut", description: "Cesur fırça darbeleri.", size: "60x80 cm", stock: 8, isNew: true, isBestSeller: false, discount: 15, reviews: [] },
