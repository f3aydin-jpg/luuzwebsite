...
export default function WallArtShop() {
  ...
  const products = [
    ...
    { id: 2, name: "Soyut Kompozisyon", images: ["https://unsplash.com/photos/abstract-painting-t2Sai-AqIpI"], priceFramed: 920, priceUnframed: 520, category: "Soyut", description: "Cesur fırça darbeleri.", size: "60x80 cm", stock: 8, isNew: true, isBestSeller: false, discount: 15, reviews: [] },
