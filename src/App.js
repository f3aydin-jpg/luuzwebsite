...
export default function WallArtShop() {
  ...
  alt={product.name} 
  className="absolute inset-0 w-full h-full object-cover transition-all duration-[850ms] ease-in-out group-hover:opacity-0 group-hover:scale-110" 
/>        
  ...
  alt={product.name} 
  className="absolute inset-0 w-full h-full object-cover transition-all duration-[850ms] ease-in-out opacity-0 group-hover:opacity-100 group-hover:scale-110" 
/>
{/* Hover Icons */}
