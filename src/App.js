...
export default function WallArtShop() {
  ...
  quickViewProduct.selectedSize === '30x40' 
    ? 'bg-stone-100 !text-black border-stone-900 dark:bg-white dark:text-stone-900 dark:border-white' 
    : '!text-black border-stone-400 hover:border-stone-900 dark:text-white dark:border-stone-500 dark:hover:border-white'
}`}
                        30x40 cm
